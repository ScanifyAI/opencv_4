            ...
            "cropAndScan" -> {
                try {
                    CropAndScan.process(
                            ...
                            call.argument<Double>("tl_x") as Double,
                            call.argument<Double>("tl_y") as Double,
                            call.argument<Double>("tr_x") as Double,
                            call.argument<Double>("tr_y") as Double,
                            call.argument<Double>("bl_x") as Double,
                            call.argument<Double>("bl_y") as Double,
                            call.argument<Double>("br_x") as Double,
                            call.argument<Double>("br_y") as Double,
                            result)


                } catch (e: Exception) {
                    result.error("OpenCV-Error", "CropToScan - Android: " + e.message, e)
                }
            }
