...
import 'package:opencv_4/factory/imagefilter/cropandscan_factory.dart';
...
class Cv2 {
  ...
  static Future<Uint8List?> cropAndscan({
    ...
    /// Variable to store operation result
    final result = await CropAndScanFactory.cropAndScan(
      pathString: pathString,
      tlX: tlX,
      tlY: tlY,
      trX: trX,
  ...
  static Future<Uint8List?> filter2D({
    ...
    /// Variable to store operation result
    final Uint8List? result = await Filter2DFactory.filter2D(pathFrom: pathFrom, pathString: pathString, outputDepth: outputDepth, kernelSize: kernelSize);
  ...
  static Future<Uint8List?> pyrMeanShiftFiltering({
    ...
    /// Variable to store operation result
    final Uint8List? result = await PyrMeanShiftFilteringFactory.pyrMeanShiftFiltering(pathFrom: pathFrom, pathString: pathString, spatialWindowRadius: spatialWindowRadius, colorWindowRadius: colorWindowRadius);
  ...
  static Future<Uint8List?> sqrBoxFilter({
    ...
    /// Variable to store operation result
    final Uint8List? result = await SqrBoxFilterFactory.sqrBoxFilter(pathFrom: pathFrom, pathString: pathString, outputDepth: outputDepth, kernelSize: kernelSize);
  ...
  static Future<dynamic> distanceTransform({
    ...
    /// Variable to store operation result
    final dynamic result = await DistanceTransformFactory.distanceTransform(pathFrom: pathFrom, pathString: pathString, distanceType: distanceType, maskSize: maskSize);
